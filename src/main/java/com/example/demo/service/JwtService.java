...
public class JwtService {
    ...
    private final long ACCESS_EXPIRATION = 10 * 60 * 1000; // 10 минут
    private final long REFRESH_EXPIRATION = 6 * 60 * 60 * 1000; // 6 часов
    private final TokenUsageService tokenUsageService;
    private final UsernameRepository usernameRepository;


    public JwtService(TokenUsageService tokenUsageService, UsernameRepository usernameRepository) {
    ...
    public Username extractUsernameModel(String token) {
        return usernameRepository.findByLogin(extractClaim(token, Claims::getSubject));
    }
